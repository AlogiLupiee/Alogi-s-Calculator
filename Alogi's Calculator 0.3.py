...
przyciskrazy = Button(tk, width = 6, height = 3, text = "*", command = lambda: klikr())
przyciskrazy.grid(column = 5, row = 1)

przyciskdziel = Button(tk, width = 6, height = 3, text = "/", command = lambda: klikd())
przyciskdziel.grid(column = 5, row = 2)
...
# - added dividing
# - changed the "=" button function
# To do:
# - add powers
# - add "C" button
# - change the code to English form partial Polish