...
tk = Tk()
tk.title("Alogi's Enchanced Calculator 0.3.2")
...
buttonpower = Button(tk, width = 6, height = 3, text = "Xʸ", command = lambda: clickpp(), bg = 'slate gray', fg = 'light blue', activebackground = 'light slate gray')
...
# change log 0.3.2:
# - fixed the powers symbol from X^2 to X^Y
# To do:
